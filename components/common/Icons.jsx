...
export function TruckIcon({ className = "w-4 h-4", ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M15 18H9" />
      <path d="M19 18h2a1 1 0 0 0 1-1v-5.5a1 1 0 0 0-.29-.71l-3.5-3.5A1 1 0 0 0 17.5 7H14v11h1" />
...
export function HeadsetIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function InstagramIcon({ className = "w-4 h-4", ...props }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="brandx-ig-gradient" x1="0%" y1="100%" x2="100%" y2="0%">
      ...
      <rect x="2" y="2" width="20" height="20" rx="5.5" fill="url(#brandx-ig-gradient)" />
      <rect x="5.25" y="5.25" width="13.5" height="13.5" rx="3.8" fill="none" stroke="#ffffff" strokeWidth="1.5" />
      <circle cx="12" cy="12" r="3.25" fill="none" stroke="#ffffff" strokeWidth="1.5" />
...
export function FacebookIcon({ className = "w-4 h-4", ...props }) {
  return (
    ...
    >
      ...
      <path
        d="M13.6 12.3h2.3l.35-2.7h-2.65V7.9c0-.75.25-1.25 1.3-1.25h1.4V4.3c-.4-.05-1.35-.15-2.5-.15-2.5 0-4.1 1.5-4.1 4.25v1.9H7.2v2.7h2.5V20c.6.08 1.15.12 1.7.12.55 0 1.1-.04 1.7-.12v-7.7h.5z"
        fill="#ffffff"
      />
    </svg>
  );
